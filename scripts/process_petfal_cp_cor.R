...
cp_freq <- read_tsv("/media/drive_5_usb/speedy/working/cytoplasm/pop_gwas/petfal/cp.clade1.2.popfreq.txt",
                    col_names = c("pop","freq"))

cp_row <- cp_freq$freq

snp_freq <- read_tsv("/media/drive_5_usb/speedy/working/cytoplasm/pop_gwas/petfal/Petiolaris.tranche90.snp.petfal.90.bi.remappedHa412HO.popfreq.txt")
...
write_tsv(tmp, "/media/drive_5_usb/speedy/working/cytoplasm/pop_gwas/petfal/Petiolaris.tranche90.snp.petfal.90.bi.remappedHa412HO.cp.cor.txt")
...
cbind(tmp,window_name ) %>%
  ...
  write_csv(.,"/media/drive_5_usb/speedy/working/cytoplasm/pop_gwas/petfal/Petiolaris.tranche90.snp.petfal.90.bi.remappedHa412HO.wzainput.txt")
# 
# #Plot WZA output
